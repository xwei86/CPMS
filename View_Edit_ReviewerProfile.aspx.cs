...
namespace CMPS_project
{
    public partial class WebForm1 : System.Web.UI.Page
    {
        ...
        protected void GVbind()
        {
            ...
            {
                con.Open();
                SqlCommand cmd = new SqlCommand("select FirstName, MiddleInitial, LastName, Affiliation, Department,Address,City,State,ZipCode,PhoneNumber,EmailAddress, Password from reviewer where EmailAddress =  @param1 and Password = @param2", con);
