<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Reviewer_area_Page.aspx.cs" Inherits="CMPS_project.WebForm6" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <p>
        <asp:Label ID="Architecture_Label" runat="server" Text="Architecture"></asp:Label>
        <asp:CheckBox ID="Architecture_CheckBox" runat="server" />
        </p>
    ...
    <p>
        <asp:Label ID="Note_Lable" runat="server" Text="Note: Check before submit"></asp:Label>
        </p>
    ...
    <p>
        <asp:Label ID="Empty_Label" runat="server" Text="                     "></asp:Label>
        </p>
