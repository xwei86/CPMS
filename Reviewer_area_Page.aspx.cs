...
namespace CPMS_project
{
    public partial class WebForm6 : System.Web.UI.Page
    {
        ...
        protected void Submit_Button_Click(object sender, EventArgs e)
        {
            ...
            if (!AnalysisOfAlgorithms_CheckBox.Checked && !Application_CheckBox.Checked && !Application_CheckBox.Checked && !Artificiallntelligence_CheckBox.Checked)
            {
            ...
            if (!all_empty_flag)
            {
                if (AnalysisOfAlgorithms_CheckBox.Checked)
                {
                    ...
                    using (SqlConnection con = new SqlConnection(cs))
                    {
                        ...
                        cmd.Connection = con;
                        cmd.CommandText = "UPDATE Reviewer SET AnalysisOfAlgorithms=@param1, WHERE EmailAddress = @username and Password = @password";
